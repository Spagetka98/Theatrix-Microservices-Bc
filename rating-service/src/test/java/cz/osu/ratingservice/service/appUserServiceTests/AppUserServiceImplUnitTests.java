package cz.osu.ratingservice.service.appUserServiceTests;

import cz.osu.ratingservice.model.pojo.UserDetails;
import cz.osu.ratingservice.service.AppUserServiceImpl;
...
class AppUserServiceImplUnitTests {
    ...
    void getUserDetails() {
        ...
        //region TESTING
        UserDetails result = appUserService.getUserDetails();
        //endregion
