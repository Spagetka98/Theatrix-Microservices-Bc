...
const LIKED_ACTIVITIES = "LikedActivities";
...
export const likedActivitiesSlice = createSlice({
  ...
  reducers: {
    ...
    clearLikedActivitiesFiltters: (state) => {
...
export const {
  ...
  setDateFiltration,
  clearLikedActivitiesFiltters,
} = likedActivitiesSlice.actions;
